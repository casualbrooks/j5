            ...
            <div className="race-card p-4 space-y-3">
                ...
                <div className="rounded border border-slate-700 bg-slate-950 p-3">
                    ...
                    <code className="mt-2 block overflow-x-auto rounded bg-black/40 p-2 text-xs text-emerald-300">
                        python3 scripts/pi_preflight.py --preview-only --camera-source /dev/video0 --capture-file track_snapshot.jpg --serve-preview --preview-host 0.0.0.0 --preview-port 8091
                    </code>
