...
Run the FastAPI starter locally with `python -m apps.racemanager.service` (honors `HTTP_HOST` / `HTTP_PORT` environment variables defined in `apps/racemanager/README.md`).
